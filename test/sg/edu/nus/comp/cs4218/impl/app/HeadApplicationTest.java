...
public class HeadApplicationTest {
	...
	private final static String TEST_STRING_11_LINES = "1" + LINE_SEPARATOR
			...
			+ LINE_SEPARATOR + "11" + LINE_SEPARATOR;
	...
	public void testHeadAppWithOption() throws HeadException {
		...
		assertEquals(
				"// Copy paste this Java Template and save it as \"PatientNames.java\""
						+ System.lineSeparator() + "import java.lang.String;"
						+ System.lineSeparator(),
				outContent.toString());
	}
	...
	public void testHeadAppWithMultiplesOption() throws HeadException {
		...
		assertEquals(
				"// Copy paste this Java Template and save it as \"PatientNames.java\""
						+ System.lineSeparator() + "import java.lang.String;"
						+ System.lineSeparator() + "import java.lang.System;"
						+ System.lineSeparator() + "import java.util.*;"
						+ System.lineSeparator() + "import java.io.*;"
						+ System.lineSeparator() + "import java.util.ArrayList;"
						+ System.lineSeparator() + "import java.util.TreeSet;"
