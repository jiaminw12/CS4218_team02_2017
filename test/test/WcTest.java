...
public class WcTest {
	...
	public void testPrintCharacterCountInFile() throws WcException {
		...
		String expectedResult = wcApp.printCharacterCountInFile("wc -m cybody40.txt");
	...
	public void testPrintLineCountInFile() throws WcException {
		...
		String expectedResult = wcApp.printNewlineCountInFile("wc -l cybody40.txt");
	...
	public void testPrintAllCountsInFile() throws WcException {
		...
		String expectedResult = wcApp.printAllCountsInFile("wc -m -w -l cybody40.txt");
		assertEquals("304" + tabString + "54" + tabString + "4" + tabString, expectedResult);
	}
	...
	public void testPrintAllCountsInStdin() throws WcException {
		...
		assertEquals("3" + tabString + "3" + tabString + "3" + tabString, expectedResult);
	}
